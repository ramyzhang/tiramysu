...
export class Engine {
    ...
    private pixelationScale: number = 0.98; // Lower = more pixelated (0.25 = very pixelated, 1.0 = no pixelation)
    ...
    async init(): Promise<void> {
        ...
        this.world.init();
        this.physics.init(this.world.player, this.world.tiramysu); // must be after world.init() so that environment meshes are loaded
