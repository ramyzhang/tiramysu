...
export class NPC extends Entity {
    ...
    constructor(
        ...
        const bubbleModel = engine.resources.getAsset('/models/tiramysu-dialogue-bubble.glb') as THREE.Object3D;
        this.dialogueBubble = new Interactable(bubbleModel as THREE.Mesh, new THREE.Vector3(0.4, 0.9, 0), name, EntityType.Interactable, false);
